import { VehicleCapacityInfo, VehicleClass } from "../types";
...
export function getVehicleTypesByClass(vehicleClass: VehicleClass): VehicleType[] {
  return Object.values(vehicleTypes).filter(type => type.class === vehicleClass);
}
